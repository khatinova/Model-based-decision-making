function [LL, N, dsurr] = LLmodelRating_april(y,D,opts)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for t = 1:N
        ...
        if s2 == 3 % make sure that s2 is also only 1 or 2, where state 2 (here coded as 3) corresponds to shapes 3 and 4
            c2 = abs(c2 - 2);
        end
